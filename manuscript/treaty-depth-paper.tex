...
% Add Bacini paper on deep and flexible PTAs here. 
...
%In one, a leader says: ``there's no way we can make that treaty commitment- the opposition will use that against us." 
...
To measure polyarchy, I draw on a measure from the Varieties of Democracy dataset (CITE HERE)% \citep{}.
